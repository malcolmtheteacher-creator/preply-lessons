...
"""        <h2>Your Turn <span class="em">🎭</span></h2>
        ...
        <h3>Round 1 — you are the customer 📮</h3>
        <p class="lead">Your parcel, the counter, and a missed-delivery card in your pocket. Priya speaks — you answer. No looking back at the phrases; trust your ear.</p>
        <div class="dialogue">
            <div class="say say-a"><span class="who-label">Priya</span>Morning. What can I do for you?</div>
            <textarea class="blank" placeholder="State the errand — where it's going, and your priority on price…"></textarea>
            <div class="say say-a"><span class="who-label">Priya</span>On the scales, please… cheapest is standard international, nine twenty.</div>
            <textarea class="blank" placeholder="Ask how long that takes, roughly — it needs to arrive by a birthday…"></textarea>
            <div class="say say-a"><span class="who-label">Priya</span>Seven to ten working days, no promises. Express is guaranteed in three.</div>
            <textarea class="blank" placeholder="Find out what the faster one costs on top — then decide out loud…"></textarea>
            <div class="say say-a"><span class="who-label">Priya</span>You'll need the customs form — the green one there.</div>
            <textarea class="blank" placeholder="Ask what to put in the box you don't understand, then declare what's really inside…"></textarea>
            <div class="say say-a"><span class="who-label">Priya</span>Lovely. Anything else today?</div>
            <textarea class="blank" placeholder="The card through the door — raise it, and ask the hopeful question about the driver…"></textarea>
            <div class="say say-a"><span class="who-label">Priya</span>Until about two it's still on the van. After that it comes back here — eighteen days, bring ID.</div>
            <textarea class="blank" placeholder="Ask what happens if you miss it again, propose your day for redelivery, and leave well…"></textarea>
        </div>

        <h3>Round 2 — now YOU are Priya 🏤</h3>
        <p class="lead">Swap chairs. It's your counter, your queue, your forms. A new customer arrives — flustered, in a hurry, form filled in wrong.</p>
        <div class="dialogue">
            <div class="say say-b"><span class="who-label">Customer</span>Hi — I need this in Australia by Friday. That's possible, right? Please say it's possible.</div>
            <textarea class="blank" placeholder="Give the honest options — which service can do it, what it costs, no false promises…"></textarea>
            <div class="say say-b"><span class="who-label">Customer</span>Fine, the fast one. I've done the form — I just wrote "gift" for the contents, that's what it is.</div>
            <textarea class="blank" placeholder="Explain kindly why customs won't accept 'gift' — get the real contents out of them…"></textarea>
            <div class="say say-b"><span class="who-label">Customer</span>Okay, okay — it's a jumper and some chocolate. Also — this card was on my mat. From three weeks ago. Is my parcel gone forever?</div>
            <textarea class="blank" placeholder="Check the dates — it's day nineteen of eighteen. Break the bad news gently, and offer what's genuinely left to offer…"></textarea>
            <div class="say say-b"><span class="who-label">Customer</span>Ugh, that's my own fault. Thanks for checking anyway. What do I owe you for the parcel?</div>
            <textarea class="blank" placeholder="Total it up, take the payment, and send them off warmer than they arrived…"></textarea>
        </div>
