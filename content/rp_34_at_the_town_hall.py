...
"""        <h2>Your Turn <span class="em">🎭</span></h2>
        ...
        <h3>Round 1 — you are the new resident 🏛️</h3>
        <p class="lead">Ticket 84, desk 3, day twenty-two of thirty. Mrs Adeyemi speaks — you answer. No looking back at the phrases.</p>
        <div class="dialogue">
            <div class="say say-a"><span class="who-label">Mrs Adeyemi</span>Number eighty-four?</div>
            <textarea class="blank" placeholder="Confirm you're in the right place — then ask for the map: what happens first?"></textarea>
            <div class="say say-a"><span class="who-label">Mrs Adeyemi</span>First I check your documents, then the residence form, then the certificate. If the folder's in order — ten minutes.</div>
            <textarea class="blank" placeholder="Find out the real document list — what does she actually need from you?"></textarea>
            <div class="say say-a"><span class="who-label">Mrs Adeyemi</span>Passport, rental contract, and the signed landlord confirmation.</div>
            <textarea class="blank" placeholder="You don't have the third one. Declare the gap before she finds it — is it a problem today?"></textarea>
            <div class="say say-a"><span class="who-label">Mrs Adeyemi</span>It's the one I can't wave through. The contract says you rented it; the confirmation says you actually live there.</div>
            <textarea class="blank" placeholder="Ask for the fallback — later, or start again from the ticket machine?"></textarea>
            <div class="say say-a"><span class="who-label">Mrs Adeyemi</span>You're in luck. I open the file today, mark it incomplete, and you bring the confirmation within two weeks — straight to this desk, no new ticket.</div>
            <textarea class="blank" placeholder="Play the plan back before betting two weeks on it — then ask her to jot it down, rooms and names…"></textarea>
            <div class="say say-a"><span class="who-label">Mrs Adeyemi</span>*writing* Room 11 for forms, Room 6 for the fee, then me. Adeyemi — mornings, not Wednesdays.</div>
            <textarea class="blank" placeholder="Last two questions: what trips people up next time — then thank her so the goodwill survives…"></textarea>
        </div>

        <h3>Round 2 — now YOU are Mrs Adeyemi 🗂️</h3>
        <p class="lead">Swap chairs. Nineteen years at desk 3, and a new arrival sits down with a beautiful folder and completely the wrong idea.</p>
        <div class="dialogue">
            <div class="say say-b"><span class="who-label">New arrival</span>Good morning! I have everything — look, all organised. The website said passport, contract, confirmation. All here!</div>
            <textarea class="blank" placeholder="Check the folder… the 'confirmation' is a photo of a signature on a phone. Refuse it — and show the path forward in the same breath…"></textarea>
            <div class="say say-b"><span class="who-label">New arrival</span>But it IS his signature! He's in Portugal! What am I supposed to do, fly there?!</div>
            <textarea class="blank" placeholder="Stay calm and precise — explain ink versus photo, and the realistic options: post, a visit, the two-week window…"></textarea>
            <div class="say say-b"><span class="who-label">New arrival</span>Two weeks… my deadline is in nine days. Am I going to be fined? Deported?! My colleague said—</div>
            <textarea class="blank" placeholder="The honest picture: what's actually at risk in nine days, what isn't, and what you can do today to protect them…"></textarea>
            <div class="say say-b"><span class="who-label">New arrival</span>Opened today, marked incomplete, nine days is plenty. Okay. Okay! Thank you. Is there… anything else that will surprise me?</div>
            <textarea class="blank" placeholder="Give them the two classic traps — the ones you've watched people fail on for nineteen years…"></textarea>
        </div>
