...
"""        <h2>Your Turn <span class="em">🎭</span></h2>
        ...
        <h3>Round 1 — you are the trainer 🪜</h3>
        <p class="lead">Monday, 8:55am. Priya stands at your desk holding a notebook like a shield. She speaks — you build a colleague, not an audience.</p>
        <div class="dialogue">
            <div class="say say-a"><span class="who-label">Priya</span>Hi — I'm Priya, the new… well, you know. They said you'd train me. I read the handbook twice and I still don't really know how anything works.</div>
            <textarea class="blank" placeholder="Open the question economy, and set the shape of the week…"></textarea>
            <div class="say say-a"><span class="who-label">Priya</span>Okay… then can I stop you already? You just did something on that screen — three clicks — and I have no idea what any of them were.</div>
            <textarea class="blank" placeholder="She caught your blur — reward it, slow down, and kill the fear of breaking things with an honest worst case…"></textarea>
            <div class="say say-a"><span class="who-label">Priya</span>That genuinely helps. Right — can I try one? *Tuesday: an order comes in, flagged urgent, stock showing short*</div>
            <textarea class="blank" placeholder="Hand over the thinking, not the answer — what would she do next?"></textarea>
            <div class="say say-a"><span class="who-label">Priya</span>Um — split the order? No wait, it's urgent — call the customer first and ask which they'd rather?</div>
            <textarea class="blank" placeholder="She got there — confirm it, and hand her the real phone…"></textarea>
            <div class="say say-a"><span class="who-label">Priya</span>*Wednesday, quietly* I think I've done something bad. The Hendersons order — I sent it to the old address. There was a note I didn't see…</div>
            <textarea class="blank" placeholder="First aid before diagnosis — normalise, size it, then find the belief that misfired…"></textarea>
            <div class="say say-a"><span class="who-label">Priya</span>*Friday* …and that's the whole morning queue done. Released, notes checked, two customers called. Go on — say the Friday speech.</div>
            <textarea class="blank" placeholder="The map instead of memory, the handover with a rope — and praise with a receipt…"></textarea>
        </div>

        <h3>Round 2 — now YOU are Priya 📓</h3>
        <p class="lead">Swap chairs. Day one of a job you don't know, taught by your teacher in THEIR real trade. Be the honest new person — interrupt, ask, confess.</p>
        <div class="dialogue">
            <div class="say say-b"><span class="who-label">Trainer</span>Right — watch this first bit, it's easy. *does four things very fast* See? Nothing to it. Any questions?</div>
            <textarea class="blank" placeholder="You saw nothing — stop them, as invited, and say exactly where you got lost…"></textarea>
            <div class="say say-b"><span class="who-label">Trainer</span>Fair enough, slower: this first, then this, then that. Now you try one — nothing you do this week can break anything that matters.</div>
            <textarea class="blank" placeholder="Try it out loud — narrate your thinking, wrong turns included…"></textarea>
            <div class="say say-b"><span class="who-label">Trainer</span>Good — nearly. Walk me through why you chose that middle step?</div>
            <textarea class="blank" placeholder="Show your reasoning honestly — including the part you guessed…"></textarea>
            <div class="say say-b"><span class="who-label">Trainer</span>That guess is the classic one — everyone makes it. Here's the trick that stops it. Now — anything you've been embarrassed to ask all morning?</div>
            <textarea class="blank" placeholder="Spend the question you've been rationing — the 'stupid' one…"></textarea>
        </div>
