...
PLANS = {
    "everyday_echoes_dashboard.html": [
        ("🚉", "Getting around", "Stations, airports, taxis and finding your way.",
         ["At the Museum", "At the Airport", "At Passport Control", "The Car-Hire Desk",
          "At the Consulate", "The Ticket Inspector", "At the Train Station", "Taking a Taxi",
        ...
        ("🩺", "Looking after yourself", "Doctors, chemists, the gym and the hairdresser's.",
         ["At the Doctor's", "At the Pharmacy", "At the Optician", "At the Vet", "Joining a Gym",
          "At the Hairdresser's"]),
        ("🧾", "Sorting something out", "Banks, complaints, repairs and paperwork.",
         ["At the Bank", "At the Post Office", "At the Town Hall", "The House Viewing",
          "Giving a Statement", "At the School Office", "Making a Complaint",
          "Reporting Something Lost", "Car Trouble",
    ...
    "modern_life_dashboard.html": [
        ...
        ("🛡️", "Not being taken for a ride", "Scams, sellers, refunds and standing your ground.",
         ["The Scam Call", "The Bad Seller", "The Café Poster", "The Review They Want Down",
          "The Delivery Gone Wrong", "The AI Mistake", "The Holiday Rental",
          "The Better Deal", "Selling Your Sofa", "The One-Star Review", "The Bad Recommendation"]),
        ("🫂", "Being a good friend", "Turning up, saying sorry, telling the truth.",
         ["Back in Touch", "Bad News", "The Apology", "The Honest Review", "The Collab",
          "The New Friend", "Speaking for Two", "The House Guest", "Not Drinking Tonight"]),
    ...
    "english_at_work_dashboard.html": [
        ("🗣️", "In the room", "Meetings, presentations and working a crowd.",
         ["Speaking Up in the Meeting", "Chairing the Meeting", "The Presentation",
          "Working the Room", "Two Floors with the CEO"]),
        ("📈", "Asking for what you want", "Cases, deals, reviews and credit.",
         ["Asking to Work From Home", "Negotiating", "The Pay Rise", "The Client Who Won't Decide",
          "The Performance Review", "Taking the Credit"]),
        ...
        ("🌐", "Facing the public", "Selling, serving and teaching — when your job is other people.",
         ["The First Sales Call", "The Sceptical Client", "The Front Desk", "The Repair Counter", "The Native Speaker", "Parents' Evening"]),
        ("⚠️", "When it goes wrong", "Mistakes, anger, and people who aren't coping.",
         ["The Mistake", "The Deadline", "The Client Who Shouts", "Not Coping at Work",
          "The Colleague Who Cries"]),
        ("🚪", "Starting and leaving", "Interviews, handovers, training and goodbyes.",
         ["The Interview", "Your Younger Boss", "Showing the Ropes", "The Handover",
          "Suddenly the Boss", "Resigning", "Made Redundant", "Letting Someone Go"]),
    ],
}
